...
import 'package:unistay/ui/widgets/img_indicator.dart';
import '../../ui/colors/colors.dart';

class AccommodationCard extends StatelessWidget {
  final AccommodationModel accommodation;
  final int index = 0;
  AccommodationCard({super.key, required this.accommodation, required index});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, '/AccommodationDetailsPage',
                ...
                children: [
                  CarouselSlider(
                    options: CarouselOptions(
                        height: 200, enableInfiniteScroll: true),
