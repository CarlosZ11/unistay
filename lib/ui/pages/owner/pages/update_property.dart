...
class UpdatePropertyPage extends StatefulWidget {
  ...
  const UpdatePropertyPage({super.key, this.accommodationModel});
...
// Método _pickImages: Se añaden las imágenes a nuevasImagenes sin eliminar las anteriores
  ...
  @override
  void initState() {
    direccionController.text = widget.accommodationModel?.direccion ?? "";
    priceController.text = widget.accommodationModel?.price.toString() ?? "";
    descripcionController.text = widget.accommodationModel?.descripcion ?? "";
    numeroHabitaciones = widget.accommodationModel?.numeroHabitaciones ?? 1;
